...
| 2 | Suvrajit Senapati | 2301020597 | Backend service implementation, authentication logic, API route development, and database connectivity |
| 3 | Sanjay Kumar Sahoo | 2301020568 | Administrative module development, issue moderation workflow, analytics-related features, and report handling tools |
| 4 | Satya Spandan Rout | 2301020570 | Frontend interface design, dashboard development, routing structure, and user interaction flow |
